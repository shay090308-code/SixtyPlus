...
public class ScheduleStudent extends BaseActivity {
        ...
        for (DayData day : weekMap.values()) {
            ...
            if (!hasVolunteering) {
                ...
                for (int i = 0; i < day.volunteerings.size(); i++) {
                    ...
                    // קו הפרדה לפני כל שורה חוץ מהראשונה
                    if (i > 0) {
                    ...
                    tvPlace.setText(v.getPlaceName());
                    tvPlace.setTextColor(Color.parseColor("#222222"));
                    tvPlace.setTextSize(14f);
                    tvPlace.setTypeface(null, Typeface.BOLD);
                    details.addView(tvPlace);
